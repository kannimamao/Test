...
function requireConfig() {
  return new Promise(resolve => {
    ...
    if ($.isNode()) {
      ...
      $.cor = process.env.JD_IMMORTAL_LATLON?JSON.parse(process.env.JD_IMMORTAL_LATLON):{"lat":34.1, "lng":120}
    }else{
